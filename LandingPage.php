...
<body>
    ...
    <header>
        ...
        <div class="head">
            ...
            <a class="button" href="<?php echo $shoppath; ?>">Shop Now</a>
        </div>
    </header>
...
<!-- //////////////////////////////// -->
    ...
    <div id="categories">
         <a class="button" id ="cat1" style="width: 20%;" href="<?php echo $categorypath.'cat_id=2' ?>"></a>
        <a class="button" id ="cat2"  style="width: 20%;" href="<?php echo $categorypath.'cat_id=3' ?>"></a>
        <a class="button" id ="cat3"  style="width: 20%;" href="<?php echo $categorypath.'cat_id=1' ?>"></a>
        <a class="button" id ="cat4"  style="width: 20%;" href="<?php echo $categorypath.'cat_id=4' ?>"></a>
    </div>
    
    <div id="categories">
         <a class="button" id ="cat5" style="width: 20%;" href="<?php echo $categorypath.'cat_id=2' ?>"></a>
        <a class="button" id ="cat6"  style="width: 20%;" href="<?php echo $categorypath.'cat_id=3' ?>"></a>
        <a class="button" id ="cat7"  style="width: 20%;" href="<?php echo $categorypath.'cat_id=1' ?>"></a>
        <a class="button" id ="cat8"  style="width: 20%;" href="<?php echo $categorypath.'cat_id=4' ?>"></a>
    </div> 
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div id = "img1" style="height:500px;">
             <img class="d-block w-100" src="https://www.georgjensen.com/on/demandware.static/-/Sites-GeorgJensen_NZ-Library/default/dwe98985f2/images/content/georgjensen/georgjensen/giftwrapping/1600x600/gifting-occasion-blue-hero-image-1600x6001600.jpg" alt="First slide" style="height:500px;" >
                </div>
          ...
          <div id = "img2" style="height:500px;">
            <img class="d-block w-100" src="https://media.istockphoto.com/photos/white-gift-box-with-red-ribbon-bow-on-blue-background-with-confetti-picture-id1190392505?k=20&m=1190392505&s=612x612&w=0&h=NV_v5IX7N3HB4OSxFiQkCbc_MmFTc7xIELyPeZelb6U=" alt="Second slide" style="height:500px;"> 
            </div>
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <div id = "img3" style="height:500px;">
           ...
           <img class="d-block w-100" src="https://t4.ftcdn.net/jpg/03/90/00/41/360_F_390004154_UuTil3wTfFNdgoSpxFSieDOTo5i2zQwK.jpg" alt="Third slide" >
                </div>
            <div class="carousel-caption d-none d-md-block">

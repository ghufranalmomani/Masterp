            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 mt-4 pt-2">
                <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                  <img src="https://media.istockphoto.com/photos/say-cheese-for-success-picture-id514325215?k=20&m=514325215&s=612x612&w=0&h=iT4hn5mRqDPFDZvaSILisHWKuzisNaVkVhFCj66CJo4=" class="img-fluid" alt="Image" />
        ...
        <div class="row text-center flx">
          ...
          <div class="row text-center flx">
            ...
            <div class="col-xl-4 col-sm-6 mb-5">
              <div class="bg-white rounded shadow-sm py-5 px-4"><img src="./img/0.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Ghufran Almomani</h5><span class="small text-uppercase text-muted">CEO - Founder <br> Back-end Expert(The PERSON for hardest tasks)</span>
            ...
            <div class="col-xl-4 col-sm-6 mb-5">
              <div class="bg-white rounded shadow-sm py-5 px-4"><img src="./img/0.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Ghufran Almomani</h5><span class="small text-uppercase text-muted">CEO - Founder <br> Scrum Master </span>
                <ul class="social mb-0 list-inline mt-3">
            ...
            <div class="col-xl-4 col-sm-6 mb-5">
              <div class="bg-white rounded shadow-sm py-5 px-4"><img src="./img/0.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Ghufran Almomani</h5><span class="small text-uppercase text-muted">CEO - Founder <br>Product Owner</span>
                <ul class="social mb-0 list-inline mt-3">
            ...
            <div class="col-xl-4 col-sm-6 mb-5 ">
              <div class="bg-white rounded shadow-sm py-5 px-4"><img src="./img/0.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Ghufran Almomani</h5><span class="small text-uppercase text-muted">CEO - Founder <br>Data Base Expert</span>
                <ul class="social mb-0 list-inline mt-3">
